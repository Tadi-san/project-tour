...
<FooterColumn title={footerLinks[6].title}
    ...
    <div className=' flexBetween footer_copyright flex-col'>
        <p>@ 2023 Allrights reserved</p>
        <span className=' text-gray'>powerd by <Link href={'/'} className=' underline text-purple-500'>Tadisan.pla</Link></span>
